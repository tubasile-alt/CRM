console.log("prontuario.js carregado v=20260307-cosmetic-context-1");
...
/* =========================
   NOVO: CONTEXTO DO PAINEL COSMIATRIA
========================= */
...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  document.querySelectorAll(".accordion-button[data-consultation-key]").forEach((btn) => {
    btn.addEventListener("click", function () {
      ...
      if (consultationKey && currentCategory === "cosmiatria") {
